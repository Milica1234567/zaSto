  ...
  return <section className="landing-hero" aria-labelledby="hero-title">
    <div className="landing-hero__inner">
      <div className="landing-hero__copy">
        ...
        <h1 id="hero-title"><span>Vaš meni.</span><em>Jedan sken daleko.</em></h1>
        <p className="landing-hero__intro">Digitalni meni koji vaši gosti otvaraju odmah - t bez aplikacije, bez PDF-a i bez komplikacija.</p>
